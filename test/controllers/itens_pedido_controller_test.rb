...
class ItensPedidoControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create item_pedido" do
    assert_difference('ItemPedido.count') do
      post itens_pedido_url, params: { item_pedido: { pedido_id: @item_pedido.pedido_id, produto_id: @item_pedido.produto_id, quantidade: @item_pedido.quantidade } }
    end
  ...
  test "should update item_pedido" do
    patch item_pedido_url(@item_pedido), params: { item_pedido: { pedido_id: @item_pedido.pedido_id, produto_id: @item_pedido.produto_id, quantidade: @item_pedido.quantidade } }
